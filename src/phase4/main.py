...
from src.audio_generate import generate_audio, generated_frames_to_waveform
from src.audio_model import initialize_audio_model
from src.audio_train import initialize_audio_optimizer, run_audio_training_loop
from src.utils import ensure_directory_exists, load_config, log_message, save_evaluation_report, save_training_history
...
def run_audio_generation_pipeline(config_path: str | Path = "config_phase4.json") -> dict[str, Any]:
