...
from src.phase5_video.storage import save_evaluation_report, save_training_history, save_video_model
...
def run_video_generation_pipeline(config_path: str | Path = "configs/phase5.json") -> dict[str, Any]:
    config = load_config(config_path)["phase5"]
    raw_video_path = Path(config.get("video_path", "data/raw/videos/sample.gif"))
