...
from src.common.io_utils import ensure_directory_exists, save_training_history
from src.common.logging_utils import log_message
from src.phase3_image.autoencoder import initialize_autoencoder, save_autoencoder
from src.phase3_image.dataset import (
    create_image_data_loader,
    flatten_images,
    load_mnist_dataset,
    split_image_dataset,
)
from src.phase3_image.train import initialize_autoencoder_optimizer, run_autoencoder_training
...
def run_autoencoder_pipeline(config_path: str | Path = "configs/phase3.json") -> dict[str, Any]:
